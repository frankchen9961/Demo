...
-- Database: SQL Server
-- Generated at: 2025-12-18T02:57:45.344Z
...
CREATE TABLE [qa_main] (
  [id] bigint PRIMARY KEY IDENTITY(1, 1),
  [qa_category_id] bigint NOT NULL,
...
CREATE INDEX [idx_qa_category_subdomain] ON [qa_category] ("subdomain_id")
GO

CREATE INDEX [idx_qa_category_parent] ON [qa_category] ("parent_id")
GO

CREATE INDEX [idx_qa_main_category] ON [qa_main] ("qa_category_id")
GO
...
@value = '唯一識別碼',
@level0type = N'Schema', @level0name = 'dbo',
@level1type = N'Table',  @level1name = 'qa_category',
@level2type = N'Column', @level2name = 'id';
GO
...
@level0type = N'Schema', @level0name = 'dbo',
@level1type = N'Table',  @level1name = 'qa_main',
@level2type = N'Column', @level2name = 'qa_category_id';
GO
...
ALTER TABLE [qa_category] ADD FOREIGN KEY ([subdomain_id]) REFERENCES [subdomain] ([id])
GO

ALTER TABLE [qa_category] ADD FOREIGN KEY ([parent_id]) REFERENCES [qa_category] ([id])
GO

ALTER TABLE [qa_main] ADD FOREIGN KEY ([qa_category_id]) REFERENCES [qa_category] ([id])
GO
